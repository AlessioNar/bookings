...
func main() {
	// Run the application, check for errors and (after finishing the function, close the database connection)
	db, err := run()
	if err != nil {
		log.Fatal(err)
	}
...
func run() (*driver.DB, error) {
	...
	// Register models to be included into the session
	...
	// Create a template cache and add it to app
